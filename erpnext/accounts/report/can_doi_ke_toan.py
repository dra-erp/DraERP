...
def get_giatri(nam,maso,periodicity,company,finance_book):
	if periodicity=="Yearly":
		...
		if maso == '100':
			...
			return (tinh_No_Cua_Yearly(nam,'111%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'112%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'113%%',company,finance_book)) + (tinh_No_Cua_Yearly(nam,'12811%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'12881%%',company,finance_book))
		elif maso == '111':
			return tinh_No_Cua_Yearly(nam,'111%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'112%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'113%%',company,finance_book)
		elif maso == '112':
			...
			return tinh_No_Cua_Yearly(nam,'1311%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'3311%%',company,finance_book) + (tinh_No_Cua_Yearly(nam,'13621%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'13631%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'13681%%',company,finance_book)) + tinh_No_Cua_Yearly(nam,'337%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'12831%%',company,finance_book) + (tinh_No_Cua_Yearly(nam,'13851%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'13881%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'1411%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'2441%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'334%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'3381%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'3382%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'3383%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'3384%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'33851%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'3386%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'33871%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'33881%%',company,finance_book)) + tinh_Co_Cua_Yearly(nam,'22931%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'1381%%',company,finance_book)
		elif maso == '131':
			...
			return tinh_Co_Cua_Yearly(nam,'2141%%',company,finance_book)
		elif maso == '224':
			...
			return tinh_No_Cua_Yearly(nam,'221%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'222%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'2292%%',company,finance_book) + (tinh_No_Cua_Yearly(nam,'12813%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'12822%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'12883%%',company,finance_book))
		elif maso == '251':
			return tinh_No_Cua_Yearly(nam,'221%%',company,finance_book)
		elif maso == '252':
			...
			return tinh_No_Cua_Yearly(nam,'2422%%',company,finance_book) - 4000000 + tinh_No_Cua_Yearly(nam,'243%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'22882%%',company,finance_book)
		elif maso == '261':
			return tinh_No_Cua_Yearly(nam,'2422%%',company,finance_book)
		elif maso == '262':
			return tinh_No_Cua_Yearly(nam,'243%%',company,finance_book)
		elif maso == '263':
			return tinh_No_Cua_Yearly(nam,'15342%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'22943%%',company,finance_book)
		elif maso == '268':
			...
			return tinh_Co_Cua_Yearly(nam,'3311%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'1311%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'333%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'334%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'3351%%',company,finance_book) + (tinh_Co_Cua_Yearly(nam,'33621%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'33631%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'33681%%',company,finance_book)) + tinh_Co_Cua_Yearly(nam,'337%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'33871%%',company,finance_book) + (tinh_Co_Cua_Yearly(nam,'3381%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'3382%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'3383%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'3384%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'33851%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'3386%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'33881%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'138%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'3441%%',company,finance_book)) + (tinh_Co_Cua_Yearly(nam,'34111%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'34121%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'343111%%',company,finance_book)) + (tinh_Co_Cua_Yearly(nam,'35211%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'35221%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'35231%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'35241%%',company,finance_book)) + tinh_Co_Cua_Yearly(nam,'353%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'357%%',company,finance_book) +  1794402525 + tinh_Co_Cua_Yearly(nam,'171%%',company,finance_book) + (tinh_Co_Cua_Yearly(nam,'3312%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'1312%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'3352%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'3361%%',company,finance_book) + (tinh_Co_Cua_Yearly(nam,'33622%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'33632%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'33682%%',company,finance_book)) + tinh_Co_Cua_Yearly(nam,'33872%%',company,finance_book) + (tinh_Co_Cua_Yearly(nam,'3442%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'33852%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'33882%%',company,finance_book)) + (tinh_Co_Cua_Yearly(nam,'34112%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'34122%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'343112%%',company,finance_book) - tinh_No_Cua_Yearly(nam,'34312%%',company,finance_book)  + tinh_Co_Cua_Yearly(nam,'34313%%',company,finance_book)) + (tinh_Co_Cua_Yearly(nam,'3432%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'411122%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'347%%',company,finance_book)) + (tinh_Co_Cua_Yearly(nam,'35212%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'35222%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'35232%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'35242%%',company,finance_book)) + tinh_Co_Cua_Yearly(nam,'356%%',company,finance_book))
		elif maso == '310':
			...
			return tinh_Co_Cua_Yearly(nam,'1311%%',company,finance_book)
		elif maso == '313':
			...
			return tinh_Co_Cua_Yearly(nam,'337%%',company,finance_book)
		elif maso == '318':
			return tinh_Co_Cua_Yearly(nam,'33871%%',company,finance_book)*2
		elif maso == '319':
			return tinh_No_Cua_Yearly(nam,'3381%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'3382%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'3383%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'3384%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'33851%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'3386%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'33881%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'138%%',company,finance_book) + tinh_No_Cua_Yearly(nam,'3441%%',company,finance_book) - 60327622 - 9000000
		elif maso == '320':
			...
			return tinh_Co_Cua_Yearly(nam,'3312%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'1312%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'3352%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'3361%%',company,finance_book) + (tinh_Co_Cua_Yearly(nam,'33622%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'33632%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'33682%%',company,finance_book)) + tinh_Co_Cua_Yearly(nam,'33872%%',company,finance_book) + (tinh_Co_Cua_Yearly(nam,'3442%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'33852%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'33882%%',company,finance_book)) + (tinh_Co_Cua_Yearly(nam,'34112%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'34122%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'343112%%',company,finance_book) - tinh_No_Cua_Yearly(nam,'34312%%',company,finance_book)  + tinh_Co_Cua_Yearly(nam,'34313%%',company,finance_book)) + (tinh_Co_Cua_Yearly(nam,'3432%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'411122%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'347%%',company,finance_book)) + (tinh_Co_Cua_Yearly(nam,'35212%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'35222%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'35232%%',company,finance_book) + tinh_Co_Cua_Yearly(nam,'35242%%',company,finance_book)) + tinh_Co_Cua_Yearly(nam,'356%%',company,finance_book)
		elif maso == '331':
			return tinh_Co_Cua_Yearly(nam,'3312%%',company,finance_book)
		elif maso == '332':
			return tinh_Co_Cua_Yearly(nam,'1312%%',company,finance_book)
		elif maso == '333':
			...
			return tinh_Co_Cua_Yearly(nam,'4212%%',company,finance_book)
		elif maso == '422':
