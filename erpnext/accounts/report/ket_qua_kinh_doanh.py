...
def tinh_No_Cua_Yearly_Cua_TK6424_6423(nam,account,company,finance_book):
	test={
		"nam":nam,
		"account":account,
	...
	return flt(frappe.db.sql("""
			select sum(debit)-sum(credit) from `tabGL Entry` as gle
			where gle.account like %(account)s and gle.fiscal_year=%(nam)s and gle.voucher_type not like 'Period Closing Voucher'
			and gle.company like %(company)sand gle.finance_book like %(finance_book)s""",test,as_list=True)[0][0],2)
def tinh_No_Cua_Yearly_Cua_TK6427_6421_6422(nam,account,company):
	test={
		"nam":nam,
		"account":account,
		"company":company
	...
	return flt(frappe.db.sql("""
			...
			where gle.account like %(account)s and gle.fiscal_year=%(nam)s and gle.voucher_type not like 'Period Closing Voucher'
			and gle.company like %(company)s""",test,as_list=True)[0][0],2)
def tinh_No_Cua_Yearly_Cua_TK6428(nam,company,finance_book):
	test={
		"nam":nam,
		"company":company,
...
def tinh_No_Khac_Yearly(nam,account,company):
	...
	return flt(frappe.db.sql("""
			...
			where gle.account like %(account)s and gle.posting_date >= %(from_date)s and gle.posting_date<= %(to_date)s and gle.voucher_type not like 'Period Closing Voucher'
			and gle.company like %(company)s""",test,as_list=True)[0][0],2)
def tinh_No_Khac_Yearly_Cua_TK6424_6423(nam,account,company,finance_book):
	test={
		"from_date":nam.from_date,
		"to_date":nam.to_date,
		"account":account,
	...
	return flt(frappe.db.sql("""
			...
			where gle.account like %(account)s and gle.posting_date >= %(from_date)s and gle.posting_date<= %(to_date)s and gle.voucher_type not like 'Period Closing Voucher'
			and gle.company like %(company)s and gle.finance_book like %(finance_book)s""",test,as_list=True)[0][0],2)
def tinh_No_Khac_Yearly_Cua_TK6427_6421_6422(nam,account,company):
	test={
		"from_date":nam.from_date,
		"to_date":nam.to_date,
		"account":account,
	...
	return flt(frappe.db.sql("""
			...
			where gle.account like %(account)s and gle.posting_date >= %(from_date)s and gle.posting_date<= %(to_date)s and gle.voucher_type not like 'Period Closing Voucher'
			and gle.company like %(company)s""",test,as_list=True)[0][0],2)
def tinh_No_Khac_Yearly_Cua_TK6428(nam,company,finance_book):
	test={
		"from_date":nam.from_date,
		"to_date":nam.to_date,
		"finance_book":finance_book,
...
def get_giatri(nam,maso,periodicity,finance_book,company):
	...
	if periodicity=="Yearly":
		...
		if maso==1:
			...
			return (tinh_No_Cua_Yearly_Cua_TK6427_6421_6422(nam,'6427%%',company)+tinh_No_Cua_Yearly_Cua_TK6427_6421_6422(nam,'6421%%',company)+tinh_No_Cua_Yearly_Cua_TK6427_6421_6422(nam,'6422%%',company)+tinh_No_Cua_Yearly_Cua_TK6428(nam,company,finance_book)+tinh_No_Cua_Yearly_Cua_TK6424_6423(nam,'6424%%',company,finance_book)+tinh_No_Cua_Yearly_Cua_TK6424_6423(nam,'6423%%',company,finance_book))
		elif maso==30:
			return ((tinh_Co_Cua_Yearly(nam,'511%%',company)-tinh_No_Cua_Yearly(nam,'521%%',company))-tinh_No_Cua_Yearly(nam,'632%%',company))+tinh_Co_Cua_Yearly(nam,'515%%',company)-tinh_No_Cua_Yearly(nam,'635%%',company)-tinh_No_Cua_Yearly(nam,'641%%',company)-(tinh_No_Cua_Yearly_Cua_TK6427_6421_6422(nam,'6427%%',company)+tinh_No_Cua_Yearly_Cua_TK6427_6421_6422(nam,'6421%%',company)+tinh_No_Cua_Yearly_Cua_TK6427_6421_6422(nam,'6422%%',company)+tinh_No_Cua_Yearly_Cua_TK6428(nam,company,finance_book)+tinh_No_Cua_Yearly_Cua_TK6424_6423(nam,'6424%%',company,finance_book)+tinh_No_Cua_Yearly_Cua_TK6424_6423(nam,'6423%%',company,finance_book))
		elif maso==31:
			...
			return (((tinh_Co_Cua_Yearly(nam,'511%%',company)-tinh_No_Cua_Yearly(nam,'521%%',company))-tinh_No_Cua_Yearly(nam,'632%%',company))+tinh_Co_Cua_Yearly(nam,'515%%',company)-tinh_No_Cua_Yearly(nam,'635%%',company)-tinh_No_Cua_Yearly(nam,'641%%',company)-(tinh_No_Cua_Yearly_Cua_TK6427_6421_6422(nam,'6427%%',company)+tinh_No_Cua_Yearly_Cua_TK6427_6421_6422(nam,'6421%%',company)+tinh_No_Cua_Yearly_Cua_TK6427_6421_6422(nam,'6422%%',company)+tinh_No_Cua_Yearly_Cua_TK6428(nam,company,finance_book)+tinh_No_Cua_Yearly_Cua_TK6424_6423(nam,'6424%%',company,finance_book)+tinh_No_Cua_Yearly_Cua_TK6424_6423(nam,'6423%%',company,finance_book)))+(tinh_Co_Cua_Yearly_711(nam,'711%%',company,finance_book)-tinh_No_Cua_Yearly(nam,'811%%',company))
		elif maso==51:
			test={
				"nam":nam,
				"company":company
		...
		if maso==1:
			...
			return (tinh_No_Khac_Yearly_Cua_TK6427_6421_6422(nam,'6427%%',company)+tinh_No_Khac_Yearly_Cua_TK6427_6421_6422(nam,'6421%%',company)+tinh_No_Khac_Yearly_Cua_TK6427_6421_6422(nam,'6422%%',company)+tinh_No_Khac_Yearly_Cua_TK6428(nam,company,finance_book)+tinh_No_Khac_Yearly_Cua_TK6424_6423(nam,'6424%%',company,finance_book)+tinh_No_Khac_Yearly_Cua_TK6424_6423(nam,'6423%%',company,finance_book))
		elif maso==30:
			return ((tinh_Co_Khac_Yearly(nam,'511%%',company)-tinh_No_Khac_Yearly(nam,'521%%',company))-tinh_No_Khac_Yearly(nam,'632%%',company))+tinh_Co_Khac_Yearly(nam,'515%%',company)-tinh_No_Khac_Yearly(nam,'635%%',company)-tinh_No_Khac_Yearly(nam,'641%%',company)-(tinh_No_Khac_Yearly_Cua_TK6427_6421_6422(nam,'6427%%',company)+tinh_No_Khac_Yearly_Cua_TK6427_6421_6422(nam,'6421%%',company)+tinh_No_Khac_Yearly_Cua_TK6427_6421_6422(nam,'6422%%',company)+tinh_No_Khac_Yearly_Cua_TK6428(nam,company,finance_book)+tinh_No_Khac_Yearly_Cua_TK6424_6423(nam,'6424%%',company,finance_book)+tinh_No_Khac_Yearly_Cua_TK6424_6423(nam,'6423%%',company,finance_book))
		elif maso==31:
			...
			return (((tinh_Co_Khac_Yearly(nam,'511%%',company)-tinh_No_Khac_Yearly(nam,'521%%',company))-tinh_No_Khac_Yearly(nam,'632%%',company))+tinh_Co_Khac_Yearly(nam,'515%%',company)-tinh_No_Khac_Yearly(nam,'635%%',company)-tinh_No_Khac_Yearly(nam,'641%%',company)-(tinh_No_Khac_Yearly_Cua_TK6427_6421_6422(nam,'6427%%',company)+tinh_No_Khac_Yearly_Cua_TK6427_6421_6422(nam,'6421%%',company)+tinh_No_Khac_Yearly_Cua_TK6427_6421_6422(nam,'6422%%',company)+tinh_No_Khac_Yearly_Cua_TK6428(nam,company,finance_book)+tinh_No_Khac_Yearly_Cua_TK6424_6423(nam,'6424%%',company,finance_book)+tinh_No_Khac_Yearly_Cua_TK6424_6423(nam,'6423%%',company,finance_book)))+(tinh_Co_Khac_Yearly_711(nam,'711%%',company,finance_book)-tinh_No_Khac_Yearly(nam,'811%%',company))
		elif maso==51:
			return flt(frappe.db.sql("""
			select (sum(debit)-sum(credit)) from `tabGL Entry` as gle
