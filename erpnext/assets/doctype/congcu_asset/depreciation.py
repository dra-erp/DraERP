...
def get_depreciable_assets(date):
	return frappe.db.sql_list("""select a.name
		from tabCongCu_Asset a, `tabDepreciation Schedule` ds
...
def scrap_asset(asset_name):
	...
	frappe.db.set_value("CongCu_Asset", asset_name, "disposal_date", today())
	frappe.db.set_value("CongCu_Asset", asset_name, "journal_entry_for_scrap", je.name)
