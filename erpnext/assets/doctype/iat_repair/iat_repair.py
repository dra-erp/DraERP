...
class IaTRepair(AccountsController):
	def validate(self):
		self.asset_doc = frappe.get_doc('IaT', self.asset)
		self.update_status()
	...
	def update_status(self):
		if self.repair_status == 'Pending':
			frappe.db.set_value('IaT', self.asset, 'status', 'Out of Order')
		else:
	...
	def before_submit(self):
		...
		if self.get('capitalize_repair_cost'):
			...
			if frappe.db.get_value('IaT', self.asset, 'calculate_depreciation') and self.increase_in_asset_life:
