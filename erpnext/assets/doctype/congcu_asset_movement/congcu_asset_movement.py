...
class CongCu_Asset_Movement(Document):
	...
	def validate_asset(self):
		for d in self.assets:
			status, company = frappe.db.get_value("CongCu_Asset", d.asset, ["status", "company"])
	...
	def set_latest_location_in_asset(self):
		...
		for d in self.assets:
			...
			frappe.db.set_value('CongCu_Asset', d.asset, 'location', current_location)
			frappe.db.set_value('CongCu_Asset', d.asset, 'custodian', current_employee)
